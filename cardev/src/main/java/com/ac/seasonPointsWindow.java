...
public class seasonPointsWindow extends newSeason {
    ...
    public static final ObservableList<String> positionPointsNew = 
    FXCollections.observableArrayList();

    public static final ObservableList<String> positionRewardsNew = 
    FXCollections.observableArrayList();

    public static final ObservableList<String> positionPointsOld = 
    FXCollections.observableArrayList();

    public static final ObservableList<String> positionRewardsOld = 
    FXCollections.observableArrayList();
    ...
    private seasonSettings loadedSeason = new seasonSettings(loadedProfile, difficulty, difficulty, difficulty, difficulty, difficulty, difficulty, difficulty, difficulty, difficulty, difficulty, setNumbersOnlyIndex, difficulty, raceRewards, difficulty, false, false, false, false, newRacePoints, newRaceRewardRates);
