...
public class startRace extends App implements Initializable {
    ...
    @FXML
    void btnStartRaceClick(ActionEvent event) throws InterruptedException {
        ...
        if (chkPreSeasonTesting.isSelected()) {
            lblLoadingTeam.setText("Pre-season skipped. Press 'Start Session' before starting the session in Assetto Corsa");
            season.setPreseasonTestingCompleted(true);
            season.setCurrentRace(season.getCurrentRace() + 1);
